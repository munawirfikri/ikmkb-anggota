...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8">
    <!-- Welcome Card -->
    <div class="lg:col-span-2 bg-gradient-to-r from-green-500 to-green-600 rounded-lg shadow-lg text-white p-4 lg:p-6">
        <h2 class="text-xl lg:text-2xl font-bold mb-2">Selamat Datang, {{ $anggota->nama_lengkap }}!</h2>
        <p class="text-green-100 mb-4">Terima kasih telah bergabung dengan IKMKB Jakarta. Nikmati berbagai fasilitas dan kegiatan yang tersedia.</p>
    ...
    <div class="bg-white rounded-lg shadow-lg p-4 lg:p-6">
        <div class="text-center">
            ...
            <a href="{{ route('profile') }}" class="mt-4 inline-block bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700">
                Edit Profile
            </a>
        </div>
    </div>
                ...
                <div class="flex items-start space-x-4 pb-4 border-b border-gray-100 last:border-b-0">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="${item.link}" target="_blank" class="text-xs text-green-600 hover:text-green-700">Baca selengkapnya</a>
                        </div>
                    </div>
                </div>
            `).join('');
