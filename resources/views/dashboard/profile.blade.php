    ...
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="p-4 sm:p-6">
            ...
            <div class="mb-6 sm:mb-8 text-center">
                ...
                <div>
                    <label for="foto" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 cursor-pointer">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
                ...
                <div class="space-y-3 sm:space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_lengkap" value="{{ $anggota->nama_lengkap }}" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">
                    </div>

                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">Email *</label>
                        <input type="email" name="email" value="{{ $anggota->email }}" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="tempat_lahir" value="{{ $anggota->tempat_lahir }}" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">
                    </div>

                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">Tanggal Lahir *</label>
                        <input type="date" name="tanggal_lahir" value="{{ $anggota->tanggal_lahir->format('Y-m-d') }}" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">
                    </div>
                ...
                <div class="space-y-3 sm:space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="no_telepon" value="{{ $anggota->no_telepon }}" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">
                    </div>

                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">Pekerjaan *</label>
                        <input type="text" name="pekerjaan" value="{{ $anggota->pekerjaan }}" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">
                    </div>

                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">Alamat Lengkap di Jakarta *</label>
                        <textarea name="alamat_jakarta" required rows="3" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">{{ $anggota->alamat_jakarta }}</textarea>
                    </div>

                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">Kota Bagian *</label>
                        <select name="kota_bagian" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">
                    ...
                    <div>
                        ...
                        <select name="status_rumah" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">
            ...
            <div class="mt-6 sm:mt-8 border-t pt-4 sm:pt-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        ...
                        <input type="password" name="password" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-green-500">
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-4">
                ...
                <button type="submit" class="px-4 sm:px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
                    Simpan Perubahan
                </button>
            </div>
        </form>
