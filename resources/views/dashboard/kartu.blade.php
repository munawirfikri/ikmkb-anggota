...
<div class="max-w-2xl mx-auto px-4 sm:px-0">
    <!-- Digital Member Card -->
    <div class="bg-gradient-to-br from-green-600 via-green-700 to-green-800 rounded-xl shadow-2xl p-4 sm:p-6 lg:p-8 text-white relative overflow-hidden">
        <!-- Background Pattern -->
        ...
        <div class="relative z-10">
            <div class="flex justify-between items-start mb-6">
                <div>
                    <h2 class="text-xl sm:text-2xl font-bold">IKMKB JAKARTA</h2>
                    <p class="text-green-200">Ikatan Keluarga Masyarakat Kabupaten Bengkalis Jakarta</p>
                </div>
            ...
            <div class="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 mb-6">
                ...
                <div class="flex-1 text-center sm:text-left">
                    ...
                    <p class="text-green-200">{{ $anggota->pekerjaan }}</p>
                    <p class="text-green-200">{{ $anggota->tempat_lahir }}, {{ $anggota->tanggal_lahir->format('d M Y') }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                <div>
                    <p class="text-green-200 text-sm">No. Anggota</p>
                ...
                <div class="sm:col-span-2">
                    <p class="text-green-200 text-sm">Bergabung</p>
    ...
    <div class="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-4">
        <button onclick="downloadCard()" class="bg-green-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-green-700 flex items-center justify-center space-x-2">
            <i class="fas fa-download"></i>
            <span>Download Kartu</span>
        </button>
        <button onclick="shareCard()" class="bg-green-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-green-700 flex items-center justify-center space-x-2">
...
<script>
    ...
    function shareCard() {
        ...
        if (navigator.share) {
            navigator.share({
                title: 'Kartu Anggota IKMKB Jakarta',
                text: 'Saya adalah anggota IKMKB Jakarta dengan nomor {{ $anggota->no_anggota }}',
